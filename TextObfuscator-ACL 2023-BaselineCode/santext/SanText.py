...
def SanText_plus_init(prob_matrix_init, word2id_init, sword2id_init, all_words_init, p_init, tokenizer_init, task_name_init):
    global prob_matrix
    global word2id
    global sword2id
    global id2sword
...
def SanText_plus(doc):
    ...
    # if task_name not in ["conll2003","ontonotes"]:
