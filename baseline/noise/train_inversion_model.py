...
if __name__ == "__main__":
    dataset = 'sst2'
    model_name = '/root/contrastive_privacy/version_noise/ckpts/sst2/epsilon0.5_nu0.1_lr1e-5'
    ...
    add_noise = True
    epsilon = 0.5
    add_word_dropout = True
    nullification_rate = 0.1
    wandb_name = f'*invertionPLM_noise_sst2_epsilon0.5_nu0.1'
