...
def evaluate_with_knn_attack(model, tokenizer, dataloader, metric, accelerator, topk=5, target_layer=3):
...
def main():
    ...
    # test!
    eval_metric = evaluate_with_knn_attack(model, tokenizer, eval_dataloader, metric, accelerator, topk=10, target_layer=args.target_layer)
    if args.use_wandb:
