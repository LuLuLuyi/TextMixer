...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default='/root/mixup/baseline/datamix/ckpts', help="Where to store the final model.")
...
def main():
    ...
    from models.modeling_bert_mixup import BertForSequenceClassification
    ...
    if args.use_wandb:
        project_name = f'datamix_{args.task_name}'
