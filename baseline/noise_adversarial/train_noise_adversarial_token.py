...
def main():
    ...
    from models.modeling_bert_embedding_noise import BertForTokenClassification
    ...
    if args.use_wandb:
        project_name = f'cape_{args.dataset_name}' if 'ontonotes' not in args.dataset_name else 'cape_ontonotes'
    ...
    if args.train_task_model:
        ...
        for epoch in range(starting_epoch, args.num_train_epochs):
            ...
            for step, batch in enumerate(train_dataloader):
                ...
                feature = outputs_adversarial['hidden_states'].detach().clone()
