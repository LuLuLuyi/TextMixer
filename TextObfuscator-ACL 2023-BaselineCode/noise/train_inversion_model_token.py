...
def bulid_dataloader_token(task_name='ner', train_file='/root/honor_dataset/clear_train_1000.json', eval_file='/root/honor_dataset/test.json', max_length=128):
...
if __name__ == "__main__":
    dataset = 'conll2003'
    model_name = '/root/contrastive_privacy/version_noise/ckpts/ner/epsilon5_nu-1'
    ...
    task_name='conll2003'
    topk = 1
    wandb_name = f'invertionPLM_noise_ner_epsilon5_nu-1'
    ...
    # Load dataset
    train_dataloader, eval_dataloader = bulid_dataloader_token(task_name)
